...
order: 2
showInNav: true
description: How the environment shapes evolutionary selection among microbial populations, and what that means for disease burden.
---

The environment — climatic or sociodemographic — shapes the patterns of infectious disease dynamics by, for example, changing the survival of microbes during transmission, altering host behaviours, and shaping which microbial strains or genes cause disease. By building frameworks which incorporate environmental, sociodemographic, epidemiological, and microbial genomic surveillance data we can better anticipate both infectious disease outbreaks and the particular strains or genes driving them.

My research aims to understand how the environment shapes evolutionary selection among microbial populations to explain and predict disease burden and dynamics. Understanding these relationships enhances our ability to anticipate how environmental changes — increasing temperatures, prolonged drought, wildfire smoke — shape microbial populations, and to focus public health strategies on the most vulnerable regions and populations.
